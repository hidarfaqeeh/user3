...
class ModernControlBot:
    ...
    async def show_help(self, event):
        ...
        help_text = (
            "❓ **دليل الاستخدام**\n\n"
            "🎯 **كيفية إعداد البوت:**\n\n"
            "**1️⃣ تعيين محادثة المصدر:**\n"
            "• للقنوات العامة: `@channel_name`\n"
            "• للمجموعات الخاصة: `-1001234567890`\n\n"
            "**2️⃣ تعيين محادثة الهدف:**\n"
            "• نفس تنسيق محادثة المصدر\n\n"
            "**3️⃣ الحصول على معرف المحادثة:**\n"
            "• أرسل رسالة في المحادثة\n"
            "• أرسلها إلى @userinfobot\n"
            "• سيعطيك المعرف\n\n"
            "**4️⃣ تشغيل البوت:**\n"
            "• اضغط 'تشغيل البوت'\n"
            "• راقب الحالة للتأكد\n\n"
            "💡 **نصائح:**\n"
            "• تأكد من إضافة البوت للمحادثات\n"
            "• امنح البوت صلاحيات الإدارة\n"
            "• استخدم 'الإعدادات المتقدمة' للتخصيص"
        )
